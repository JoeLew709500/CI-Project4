...
urlpatterns = [
    ...
    path('<int:incident_id>/incidents_delete/', views.incident_delete, name='incident_delete'),
    path('<int:incident_id>/actions/<int:action_id>/delete/', views.action_delete, name='action_delete'),
]       